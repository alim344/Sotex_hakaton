# -*- coding: utf-8 -*-
"""
Created on Sun Apr 19 01:50:20 2026
...
def get_overload_history_from_db(engine, feeder_id: int) -> pd.DataFrame:
    query = text("""
    ...
    with engine.connect() as conn:
        return pd.read_sql(query, conn, params={"feeder_id": feeder_id})